...
class RoomProvider extends Component {
    ...
    formatData(items)
    {
        let tempItems = items.map((item)=>{
            ...
            let room = {... item.fields,images:images,id} //if the property is not present it will add it(id) and if it is present it will overwrite it with our own property(eg images)
            return room;
        });
        return tempItems
    }
